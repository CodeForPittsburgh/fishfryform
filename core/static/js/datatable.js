...
$(document).ready(function() {
    ...
    var table = $('#data-table').DataTable({
        ...
        dom: 'lfrtip',
        ajax: {
            url: "https://christianbgass.carto.com/api/v2/sql?q=SELECT venue_name, venue_address, validated, publish, cartodb_id FROM fishfrymap WHERE validated = false AND publish = false",
            type: 'GET',
            dataSrc: 'rows'
        },
        deferRender: true,
