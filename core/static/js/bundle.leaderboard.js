...
$(function () {
  ...
  var colorsToAssign = [window.chartColors.blue, window.chartColors.green, window.chartColors.yellow, window.chartColors.red];

  if (summaryChartData) {
    var summaryChartDatasetsWithColors = summaryChartData.datasets.map(function (d, i) {
      var d2 = _objectSpread({}, d);
    ...
    var leaderboard = new Chart(document.getElementById("FishFryLeaderboard"), {
      type: "bar",
...
//# sourceMappingURL=bundle.leaderboard.js.map
